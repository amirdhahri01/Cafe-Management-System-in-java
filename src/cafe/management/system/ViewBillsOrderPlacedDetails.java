...
public class ViewBillsOrderPlacedDetails extends javax.swing.JFrame {
    ...
    public void tableDetails() {
        ...
        String incDesc = jComboBox1.getSelectedItem().toString();
        DefaultTableModel defaultTableModel = (DefaultTableModel) jTable1.getModel();
        defaultTableModel.setRowCount(0);
        ArrayList<Bill> bills;
        if (incDesc.equals("INC")) {
            bills = BillDao.getAllRecordsByInc(date);
        } else {
            bills = BillDao.getAllRecordsByDesc(date);
        }
        bills.forEach(bill -> {
            defaultTableModel.addRow(new Object[]{bill.getID(), bill.getName(), bill.getMobileNumber(), bill.getEmail(), bill.getDate(), bill.getTotal(), bill.getCreatedBy()});
        });
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(205, 105, -1, -1));
        ...
        getContentPane().add(txtDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 102, 250, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Change Order By ID");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(616, 105, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(791, 102, 250, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 146, 1267, 570));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("*Click on row to open bill");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 720, -1, -1));
