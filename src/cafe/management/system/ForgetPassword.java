...
public class ForgetPassword extends javax.swing.JFrame {
    ...
    private String emailPattren = "^[a-zA-Z0-9]+[@]+[a-zA-Z0-9]+[.]+[a-zA-Z0-9]+$";
    private String dbAnswer = null;
    private String dbSecurityQuestion = null;
    ...
    public void validateFields() {
        ...
        String securtiyQuestion = txtSecurityQuestion.getText();
        if (!password.equals("") && !answer.equals("") && !securtiyQuestion.equals("")) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, -1, -1));
        ...
        jLabel3.setText("Security quetion ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 320, -1, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 410, -1, -1));
        ...
        getContentPane().add(txtSecurityQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, 351, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 400, 351, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 280, 351, -1));
        ...
        getContentPane().add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 280, -1, -1));
        ...
        getContentPane().add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 500, -1, -1));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        email = txtEmail.getText();
        User user = UserDao.getSecurityQuestion(email);
        if (user == null) {
