...
public class ViewEditDeleteProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 10, -1, -1));
        ...
        txtID.setText("00");
        getContentPane().add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, -1, -1));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 220, 350, -1));
        ...
        getContentPane().add(categoryComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 270, 351, -1));
        ...
        getContentPane().add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, 351, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 370, -1, -1));
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 370, -1, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 370, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 180, -1, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        products.forEach(product -> {
            defaultTableModel.addRow(new Object[]{product.getId(), product.getName(), product.getCategory(), product.getPrice()});
        });
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String category_name = tableModel.getValueAt(jTable1.getSelectedRow(), 2).toString();
        String price = tableModel.getValueAt(jTable1.getSelectedRow(), 3).toString();
        txtID.setText(id);
        ...
        categories.forEach(category -> {
            if (category.getName().equals(category_name)) {
                categoryComboBox.addItem(category_name);
            }
        });
